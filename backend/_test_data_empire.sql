...
-- function names, and with the client-side sort gone this file orders the
-- seeded questionnaire. Pillars take their own pillarid, NOT the CISA sequence
-- the real catalog uses - that is the order the API already returned via the
-- questionid tiebreaker, so the emberfall pillar arrays hold unchanged.
-- Questions and functions follow 0056's scheme, pillarid * 100 + index.
INSERT INTO public.pillars VALUES (1, 'Devices', 1) ON CONFLICT DO NOTHING;
INSERT INTO public.pillars VALUES (2, 'Applications', 2) ON CONFLICT DO NOTHING;
INSERT INTO public.pillars VALUES (3, 'Networks', 3) ON CONFLICT DO NOTHING;
INSERT INTO public.pillars VALUES (4, 'Data', 4) ON CONFLICT DO NOTHING;
INSERT INTO public.pillars VALUES (5, 'CrossCutting', 5) ON CONFLICT DO NOTHING;
INSERT INTO public.pillars VALUES (6, 'Identity', 6) ON CONFLICT DO NOTHING;
...
INSERT INTO public.questions VALUES (8001, 'Does your Imperial system track all battle stations, Star Destroyers, and TIE fighters with comprehensive inventory?', 'What tools does the Imperial Navy use to track Death Stars, Super Star Destroyers, and fighter assets? Include details about maintenance schedules and operational status.', 1, 101) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8002, 'How does your system manage Imperial device supply chain risks from Rebel sabotage?', 'Describe security measures for Imperial manufacturing facilities and component verification processes. Include protocols for detecting tampered equipment.', 1, 102) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8003, 'What threat protection is integrated into all Imperial device workflows?', 'Detail automated security scanning for Imperial vessels and equipment. Include real-time monitoring of device behavior and anomaly detection.', 1, 103) ON CONFLICT DO NOTHING;

-- Applications Pillar Questions  
INSERT INTO public.questions VALUES (8004, 'How does your system integrate security testing throughout Imperial software development?', 'What tools does the Imperial Engineering Corps use to test superlaser targeting systems, reactor control applications, and tactical software?', 2, 201) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8005, 'Does your system enforce security policies for Death Star application development and deployment?', 'Describe automated policy enforcement for critical Imperial applications. Include details about secure coding standards and deployment controls.', 2, 202) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8006, 'What security monitoring covers all Imperial applications to maintain Death Star-wide visibility?', 'Detail application performance monitoring and security event correlation across all Imperial battle station systems.', 2, 203) ON CONFLICT DO NOTHING;
...
INSERT INTO public.questions VALUES (8010, 'How does your system identify and manage Imperial tactical data inventory?', 'What tools does the Imperial Security Bureau use to automatically catalog Death Star plans, fleet positions, and strategic intelligence?', 4, 401) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8011, 'Does your system have automated processes for Imperial data lifecycle and security policies?', 'Describe automated classification, encryption, and retention policies for sensitive Imperial military data and intelligence reports.', 4, 402) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8012, 'What visibility does your system provide across the full Imperial data lifecycle with analytics?', 'Detail data access monitoring, usage analytics, and compliance reporting for Imperial classified information and tactical databases.', 4, 403) ON CONFLICT DO NOTHING;

-- CrossCutting Pillar Questions
INSERT INTO public.questions VALUES (8013, 'How does your system coordinate Imperial security policies across all battle stations and fleets?', 'Describe centralized policy management, enforcement mechanisms, and compliance monitoring across the entire Imperial military structure.', 5, 501) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8014, 'What automated governance processes ensure consistent Imperial security across all systems?', 'Detail automated policy deployment, configuration management, and compliance verification for Empire-wide security standards.', 5, 502) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8015, 'How does your system provide comprehensive security analytics and reporting for Imperial leadership?', 'Describe security dashboards, threat intelligence reporting, and strategic security metrics provided to Imperial command structure.', 5, 503) ON CONFLICT DO NOTHING;

-- Identity Pillar Questions
INSERT INTO public.questions VALUES (8016, 'How does your system authenticate and verify Imperial officer identities across all access points?', 'Describe authentication mechanisms, biometric verification, and clearance level management for Imperial personnel access to sensitive systems.', 6, 601) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8017, 'What measures detect Force-sensitive individuals or Rebel infiltrators attempting system access?', 'Detail identity verification processes, behavioral analysis, and security screening protocols to identify potential security threats among personnel.', 6, 602) ON CONFLICT DO NOTHING;
INSERT INTO public.questions VALUES (8018, 'How does your system manage Imperial identity lifecycle from recruitment to retirement?', 'Describe automated identity provisioning, access reviews, and deprovisioning processes for Imperial officers, contractors, and service accounts.', 6, 603) ON CONFLICT DO NOTHING;
...
INSERT INTO public.functions VALUES (7001, 'Imperial Device Management', 'Track and secure all Imperial battle stations, Star Destroyers, and TIE fighters', 'Imperial-Fleet', 8001, 1, 101) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7002, 'Fleet Application Security', 'Secure fleet command applications and tactical software', 'Imperial-Fleet', 8004, 2, 201) ON CONFLICT DO NOTHING;
...
INSERT INTO public.functions VALUES (7004, 'Fleet Data Protection', 'Safeguard tactical intelligence from unauthorized access', 'Imperial-Fleet', 8010, 4, 401) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7005, 'Imperial Cross-Cutting Controls', 'Enforce Empire-wide security policies across all systems and fleets', 'Imperial-Fleet', 8013, 5, 501) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7006, 'Imperial Identity Verification', 'Authenticate Imperial officers and detect Force-sensitive infiltrators', 'Imperial-Fleet', 8016, 6, 601) ON CONFLICT DO NOTHING;

-- Space-Station functions (system 1001 - Death Star) - one per pillar
INSERT INTO public.functions VALUES (7007, 'Battle Station Device Management', 'Track and secure all Death Star systems and defensive installations', 'Space-Station', 8001, 1, 101) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7008, 'Death Star Application Security', 'Secure superlaser targeting systems and reactor core applications', 'Space-Station', 8004, 2, 201) ON CONFLICT DO NOTHING;
...
INSERT INTO public.functions VALUES (7010, 'Death Star Data Protection', 'Safeguard Death Star plans and schematics from unauthorized access', 'Space-Station', 8010, 4, 401) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7011, 'Station Cross-Cutting Controls', 'Enforce security policies across all Death Star subsystems', 'Space-Station', 8013, 5, 501) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7012, 'Station Identity Verification', 'Authenticate personnel accessing Death Star critical systems', 'Space-Station', 8016, 6, 601) ON CONFLICT DO NOTHING;

-- Forest-Moon functions (system 1003 - Shield Generator) - one per pillar
INSERT INTO public.functions VALUES (7013, 'Bunker Device Management', 'Track and secure shield generator equipment and AT-ST walkers', 'Forest-Moon', 8001, 1, 101) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7014, 'Bunker Application Security', 'Secure shield generator control applications', 'Forest-Moon', 8004, 2, 201) ON CONFLICT DO NOTHING;
...
INSERT INTO public.functions VALUES (7016, 'Bunker Data Protection', 'Safeguard shield generator technical data and access codes', 'Forest-Moon', 8010, 4, 401) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7017, 'Moon Cross-Cutting Controls', 'Enforce security policies across all Forest Moon installations', 'Forest-Moon', 8013, 5, 501) ON CONFLICT DO NOTHING;
INSERT INTO public.functions VALUES (7018, 'Moon Identity Verification', 'Authenticate Imperial personnel and detect Rebel infiltrators on Endor', 'Forest-Moon', 8016, 6, 601) ON CONFLICT DO NOTHING;
...
INSERT INTO public.questions VALUES
    (8019, 'Does your ground-assault force maintain a verified inventory of every walker, speeder, and emplacement?', 'Detail how AT-AT, AT-ST, and artillery assets are tracked through deployment, battlefield loss, and salvage.', 1, 111),
    (8020, 'How is targeting and fire-control software for ground assets secured against tampering?', 'Describe code-signing and change control for walker targeting and artillery fire-control applications.', 2, 211),
    ...
    (8022, 'How is battlefield intelligence classified, encrypted, and purged on capture risk?', 'Detail handling of ground-campaign maps, troop dispositions, and emergency data destruction.', 4, 411),
    (8023, 'How are ground-campaign security policies enforced consistently across dispersed units?', 'Describe centralized policy push and compliance checks for units operating out of contact.', 5, 511),
    (8024, 'How are field commissions and trooper credentials verified at forward positions?', 'Detail identity and clearance verification when reinforcements rotate through a front line.', 6, 611)
ON CONFLICT DO NOTHING;
-- Surveillance-Net (ISB / Intelligence): 8025-8030
INSERT INTO public.questions VALUES
    (8025, 'Does the surveillance network inventory every listening post, probe droid, and informant feed?', 'Detail asset tracking for covert collection devices and their chain of custody.', 1, 121),
    (8026, 'How is the analysis tooling that processes intercepts protected and access-controlled?', 'Describe security testing and least-privilege for the applications that triage surveillance feeds.', 2, 221),
    ...
    (8028, 'How are informant identities and intercept archives classified and compartmented?', 'Describe encryption, need-to-know compartments, and retention for source-identifying data.', 4, 421),
    (8029, 'How are collection-authority and oversight policies enforced across the bureau?', 'Detail policy governance preventing unauthorized surveillance and ensuring auditability.', 5, 521),
    (8030, 'How are analyst and handler identities verified for access to compartmented intelligence?', 'Describe clearance-tiered authentication and continuous vetting for intelligence personnel.', 6, 621)
ON CONFLICT DO NOTHING;
-- Shipyard-RnD (Sienar / Kuat): 8031-8036
INSERT INTO public.questions VALUES
    (8031, 'Does the R&D program track every prototype, test article, and fabrication rig?', 'Detail inventory and provenance for experimental hulls, drives, and weapon prototypes.', 1, 131),
    (8032, 'How is the design and simulation software for new weapon systems secured?', 'Describe secure development and integrity verification for CAD, simulation, and CAM toolchains.', 2, 231),
    ...
    (8034, 'How are classified schematics (e.g., superweapon plans) protected across their lifecycle?', 'Describe classification, encryption, and access logging for top-secret design data.', 4, 431),
    (8035, 'How are export, contractor, and security policies enforced across the R&D enterprise?', 'Detail governance over contractor access and consistent policy across program sites.', 5, 531),
    (8036, 'How are engineer, contractor, and service-account identities managed for design systems?', 'Describe provisioning, review, and deprovisioning for a mixed workforce on classified programs.', 6, 631)
ON CONFLICT DO NOTHING;
...
INSERT INTO public.functions VALUES
    ...
    (7019, 'Ground Asset Management',        'Track walkers, speeders, and emplacements through their lifecycle',     'Ground-Assault',   8019, 1, 111),
    (7020, 'Fire-Control Application Security','Secure walker targeting and artillery fire-control software',          'Ground-Assault',   8020, 2, 211),
    (7021, 'Field Network Security',         'Segment and protect forward-operating-base tactical networks',          'Ground-Assault',   8021, 3, 311),
    (7022, 'Battlefield Data Protection',    'Classify and protect ground-campaign intelligence and dispositions',    'Ground-Assault',   8022, 4, 411),
    (7023, 'Ground Campaign Governance',     'Enforce security policy consistently across dispersed ground units',    'Ground-Assault',   8023, 5, 511),
    (7024, 'Field Identity Verification',    'Verify field commissions and trooper credentials at forward positions', 'Ground-Assault',   8024, 6, 611),
    -- Surveillance-Net (7025-7030)
    (7025, 'Collection Asset Management',    'Inventory listening posts, probe droids, and informant feeds',          'Surveillance-Net', 8025, 1, 121),
    (7026, 'Analysis Tooling Security',      'Protect and least-privilege the intercept-analysis applications',       'Surveillance-Net', 8026, 2, 221),
    ...
    (7028, 'Source Data Protection',         'Compartment and encrypt informant identities and intercept archives',   'Surveillance-Net', 8028, 4, 421),
    (7029, 'Collection Oversight Governance','Enforce collection-authority and oversight policy across the bureau',   'Surveillance-Net', 8029, 5, 521),
    (7030, 'Intelligence Identity Verification','Verify analyst and handler identities for compartmented access',     'Surveillance-Net', 8030, 6, 621),
    -- Shipyard-RnD (7031-7036)
    (7031, 'Prototype Asset Management',     'Track prototypes, test articles, and fabrication rigs',                 'Shipyard-RnD',     8031, 1, 131),
    (7032, 'Design Toolchain Security',      'Secure CAD, simulation, and fabrication software for new weapons',      'Shipyard-RnD',     8032, 2, 231),
    ...
    (7034, 'Schematic Data Protection',      'Protect classified schematics across their full lifecycle',             'Shipyard-RnD',     8034, 4, 431),
    (7035, 'R&D Enterprise Governance',      'Enforce export, contractor, and security policy across program sites',  'Shipyard-RnD',     8035, 5, 531),
    (7036, 'Engineering Identity Management','Manage engineer, contractor, and service-account identities',           'Shipyard-RnD',     8036, 6, 631)
ON CONFLICT DO NOTHING;
...
INSERT INTO public.fismasystems (fismasystemid, fismauid, fismaacronym, fismaname,
  ...
  system_operator, goco_coco_gogo, system_owner, system_owner_email, legacy, isso_name) VALUES
 (2001,'3F0A3984-EC7D-4222-6F41-24814FDE580F','MOCK-PROBE','Outer Rim Probe Droid Telemetry Network',NULL,NULL,NULL,NULL,'ISB','Imperial-Fleet',NULL,'mock.isso2001@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('ISB')),'No','Low','Major Application','NO',NULL,NULL,'Contractor',NULL,'Mock Officer 2001',NULL,'No','Mock ISSO 2001'),
 (2002,'061AC7D4-5ED1-C635-22BC-7485FAD72440','MOCK-GARRISON','Garrison Deployment Management System',NULL,NULL,NULL,NULL,'COMPNOR','Ground-Assault',NULL,'mock.isso2002@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('COMPNOR')),'No','High','Major Application','No','{IaaS}',NULL,'Contractor','GOCO','Mock Officer 2002','mock.owner2002@example.empire','No','Mock ISSO 2002'),
 (2003,'6A3D2901-9AAC-959C-7947-32D859CBFC00','MOCK-TIECRM','TIE Squadron Crew Rostering Platform',NULL,NULL,NULL,NULL,'INAV','Imperial-Fleet',NULL,'mock.isso2003@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('INAV')),'No','Low','Other','NO',NULL,'Mock Cloud Co','Agency','COCO','Mock Officer 2003',NULL,NULL,NULL),
 (2004,'A1FB02D5-8444-DF6E-9BED-F0ED08E7EB5F','MOCK-HOLOREC','HoloNet Records Repository',NULL,NULL,NULL,NULL,'IARM','Forest-Moon',NULL,'mock.isso2004@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('IARM')),'No','Moderate','Minor Standalone','Yes','{IaaS}',NULL,'Contractor','GOCO','Mock Officer 2004','mock.owner2004@example.empire',NULL,'Mock ISSO 2004'),
 (2005,'3BA18B26-999C-5919-E16B-A178D2FC10D2','MOCK-CARBON','Carbonite Freezing Chamber Controls',NULL,NULL,NULL,NULL,'ISC','Surveillance-Net',NULL,'mock.isso2005@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('ISC')),'No','Low','Major Application','No','{IaaS}',NULL,'Agency','GOCO','Mock Officer 2005','mock.owner2005@example.empire','No','Mock ISSO 2005'),
 (2006,'03697E9F-C772-EDE5-1227-49C5F3E51E45','MOCK-BOUNTY','Bounty Postings and Payments Portal',NULL,NULL,NULL,NULL,'TARK','Space-Station',NULL,'mock.isso2006@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('TARK')),'No','Low','Major Application','No',NULL,NULL,'Contractor','GOCO','Mock Officer 2006','mock.owner2006@example.empire',NULL,'Mock ISSO 2006'),
 (2007,'7C29B4D5-B9DF-8C61-66F6-55DE1510A4CE','MOCK-RATION','Trooper Ration Logistics System',NULL,NULL,NULL,NULL,'IIB','Shipyard-RnD',NULL,'mock.isso2007@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('IIB')),'No','Moderate','Major Application','NO','{SaaS}',NULL,'Agency',NULL,'Mock Officer 2007','mock.owner2007@example.empire','No','Mock ISSO 2007'),
 (2008,'39B01C98-C334-1216-F449-EB8EB80C4D01','MOCK-MEDDROID','Medical Droid Diagnostics Hub',NULL,NULL,NULL,NULL,'IEC','Forest-Moon',NULL,'mock.isso2008@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('IEC')),'No','Moderate','Other','Yes',NULL,NULL,'Contractor',NULL,'Mock Officer 2008',NULL,'Yes',NULL),
 (2009,'D1BB21B4-925C-3A45-72FB-92AF849AE564','MOCK-ACADEMY','Imperial Academy Enrollment System',NULL,NULL,NULL,NULL,'IMED','Shipyard-RnD',NULL,'mock.isso2009@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('IMED')),'No','Moderate','Major Application','No',NULL,NULL,'Contractor',NULL,'Mock Officer 2009','mock.owner2009@example.empire','No','Mock ISSO 2009'),
 (2010,'DD659E51-C1DA-0C8E-DEB9-3C1E14D5E6C4','MOCK-SCANDOC','Docking Bay Scanner Compliance Tracker',NULL,NULL,NULL,NULL,'ILOG','Ground-Assault',NULL,'mock.isso2010@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('ILOG')),'No','Moderate','Major Application','YES',NULL,NULL,'Contractor','GOCO','Mock Officer 2010',NULL,NULL,'Mock ISSO 2010'),
 ...
 (2012,'AA80EFA4-0773-FF5E-226A-9CEE3113E855','MOCK-KYBER','Kyber Crystal Supply Chain Registry',NULL,NULL,NULL,NULL,'IWPN','Surveillance-Net',NULL,'mock.isso2012@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('IWPN')),'No','Moderate','Major Application','Yes',NULL,NULL,'Agency',NULL,'Mock Officer 2012',NULL,'No','Mock ISSO 2012'),
 (2013,'B16A512C-3404-CD5B-85DB-FA352B686A9A','MOCK-COMSCAN','Fleet Comscan Aggregation Warehouse',NULL,NULL,NULL,NULL,'IGOV','Space-Station',NULL,'mock.isso2013@example.empire',TRUE,(SELECT opdiv_id FROM public.opdivs WHERE LOWER(code)=LOWER('IGOV')),'No','Moderate','Major Application','NO',NULL,NULL,'Contractor','GOGO','Mock Officer 2013','mock.owner2013@example.empire',NULL,'Mock ISSO 2013'),
