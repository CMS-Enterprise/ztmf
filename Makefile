...
# Generate frontend .env.development.local and public/config.js (admin token)
...
frontend-env:
	...
	echo "// Generated by: make frontend-env (auth token for $$DEV_EMAIL)" > ../ztmf-ui/public/config.js; \
	echo "window.ZTMF_RUNTIME_CONFIG = { authToken: \"$$TOKEN\" }" >> ../ztmf-ui/public/config.js; \
	echo "✅ Frontend configured for: $$DEV_EMAIL"; \
	echo "   Files: ../ztmf-ui/.env.development.local, ../ztmf-ui/public/config.js"; \
	echo ""; \
